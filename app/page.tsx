...
const features = [
  ...
  { title: "فواتير ضريبية أساسية مع QR", text: "إصدار وحفظ فواتير داخل النظام دون إرسال مباشر إلى زاتكا.", icon: QrCode },
...
const faqs = [
  ["هل JAADPOS يرسل الفواتير إلى زاتكا؟", "لا. هذه النسخة تصدر فواتير ضريبية إلكترونية أساسية مع QR داخل النظام. الربط المباشر مع زاتكا خدمة متقدمة لاحقًا."],
    ...
    <main className="bg-fog">
      ...
      <section className="mx-auto grid min-h-[calc(100vh-78px)] max-w-7xl items-center gap-10 px-5 py-10 lg:grid-cols-[0.95fr_1.05fr]">
        <div>
          ...
          <p className="mt-5 text-sm text-ink/55">الفوترة الإلكترونية الأساسية مع QR مفعلة. الربط المباشر مع منصة فاتورة/ZATCA غير مفعل حاليًا.</p>
        </div>
        <MarketingVisual />
      </section>
