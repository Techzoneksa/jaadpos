...
import { consoleUrl, marketingUrl } from "@/lib/domains";
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-fog px-5 py-10">
      <section className="surface w-full max-w-md rounded-lg p-6">
        ...
        <h1 className="mt-4 text-3xl font-black">تسجيل دخول العملاء</h1>
        <p className="mt-2 text-ink/60">ادخل إلى لوحة منشأتك أو شاشة POS حسب صلاحيتك.</p>
        ...
        <div className="mt-5 flex justify-between text-sm font-bold">
          <Link href={consoleUrl("/signup")} className="text-mint">حساب جديد</Link>
